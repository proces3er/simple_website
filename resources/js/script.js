...
document.getElementById('loadMore').addEventListener('click', function() {
    ...
    content.innerHTML = `
    <h2>Financial Cybersecurity Best Practices</h2>
    ...
    <h3>Use Up-to-Date Security Software</h3>
    ...
    <h3>Verify Companies Before Engaging</h3>
    ...
    <h3>Use Encrypted Websites for Transactions</h3>
    ...
    <h3>Practice Strong Password Management</h3>
    ...
    <h3>Enable Multifactor Authentication (MFA)</h3>
    ...
    <h3>Stay Alert to Phishing Attempts</h3>
    ...
    <h3>Regularly Monitor Account Statements</h3>
